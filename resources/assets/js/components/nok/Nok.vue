...
<div>
						...
						<tbody>
							...
							>
								...
								<td>
									...
									<v-btn @click="invoiceMail(invoice)" flat color="info">Mail</v-btn>
	...
	<!-- <AddNok @closeRequest="close" :openAddRequest="dispAdd" @alertRequest="showAlert" :buyers="AllBuyers"></AddNok>
	<EditNok @closeRequest="close" :openAddRequest="dispEdit" @alertRequest="showAlert" :buyers="AllBuyers" :invoiceData="editNok"></EditNok>
	<ShowNok @closeRequest="close" :openAddRequest="dispShow" @alertRequest="showAlert" :invoice="editNok"></ShowNok> -->
	<!-- <MailInvoice @closeRequest="close" :openMailRequest="dispMail" @alertRequest="showAlert" :invoice="editNok"></MailInvoice> -->
</div>
</template>

<script>
let AddNok = require('./AddNok');
let EditNok = require('./EditNok');
// let ShowNok = require('./ShowNok');
...
export default{
	...
	methods: {
		...
		invoiceEdit(invoice) {
			// console.log(invoice);
		  this.editNok = Object.assign({}, invoice)
