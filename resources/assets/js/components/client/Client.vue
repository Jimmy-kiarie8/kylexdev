...
<AddClient @closeRequest="close" :openAddRequest="dispAdd" @alertRequest="showAlert" :clients="AllClient"></AddClient>
...
<ShowClient @closeRequest="close" :openRequest="dispClient" :client="editedItem"></ShowClient>
</div>
</v-app>
</template>
...
export default {
  props: ['user', 'role'],
  components: {
    AddClient, EditClient, ShowClient, 
  }, 
  data() {
    return{
    tab: null,
    items: [
      'Active Members', 'Archived Members'
    ],
    AllClientAchived: [],
      headers: [
